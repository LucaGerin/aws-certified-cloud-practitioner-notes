...
**AWS VPN (Virtual Private Network)** consente di stabilire **connessioni sicure** tra una rete on-premise o un client remoto e una [Amazon VPC](Amazon-VPC.md) tramite Internet.  
...
Permette di connettere una rete aziendale on-premise con una [Amazon VPC](Amazon-VPC.md) tramite un tunnel IPsec.
...
| **Virtual Private Gateway (VGW)** | Gateway VPN gestito da AWS, associato alla [VPC](Amazon-VPC.md)                  |
| **Tunnel VPN IPsec**  | Due tunnel ridondanti per alta disponibilità                                |

**Caratteristiche:**

- Routing statico o BGP dinamico
- Supporto per [AWS Transit Gateway](AWS-Transit-Gateway.md)
...
- Connessione sicura tra ambienti on-premise e [Amazon VPC](Amazon-VPC.md)
...
Per un confronto approfondito tra VPN e altre opzioni di connessione, vedi: [AWS Direct Connect vs AWS VPN](AWS-Direct-Connect-VS-AWS-VPN.md)
...
2. Creare un **Virtual Private Gateway** e associarlo alla [VPC](Amazon-VPC.md)
...
- Integrazione con **[IAM](AWS-IAM.md)** per controllo accessi utente
...
| Caratteristica           | AWS Site-to-Site VPN | AWS Client VPN         | [AWS Direct Connect](AWS-Direct-Connect.md) |
|--------------------------|----------------------|-------------------------|---------------------------------------------|
