...
- Controllo accessi con [IAM](AWS-IAM.md) Policies
...
È possibile combinare **[Amazon SNS](Amazon-SNS.md) + SQS** per inviare lo stesso messaggio a più code SQS (fan-out pattern):
...
| Target supportati| Uno per consumer             | Fan-out multiplo            | [AWS Lambda](AWS-Lambda.md), [Amazon SQS](Amazon-SQS.md), [AWS Step Functions](AWS-Step-Functions.md), ecc.    |
...
- Monitora la coda con [Amazon CloudWatch](Amazon-CloudWatch.md) (numero messaggi, tempi, errori).
