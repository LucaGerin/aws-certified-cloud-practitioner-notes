...
- **Replica continua** dei dati dal sistema sorgente verso [AWS](AWS.md)
- **Test senza interruzioni** prima del cutover finale
- **Automazione del provisioning** delle istanze [Amazon EC2](Amazon-EC2.md)
...
- Spostamento di workload legacy su [Amazon EC2](Amazon-EC2.md)
...
- Integrazione con [AWS Migration Hub](AWS-Migration-Hub.md)
